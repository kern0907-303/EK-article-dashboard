...
export async function POST(req: NextRequest) {
  try {
    const { history, brandName, aiProvider, stage, expertType, subPrompts, brandGuidelines, prevData } = await req.json();
    ...
    const result = await callErickCOO(history || [], brandName, aiProvider, stage, expertType, subPrompts, brandGuidelines, prevData);
