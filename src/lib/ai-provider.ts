...
export async function callTheoAnalysis(
  ...
  if (provider === "mock") {
    ...
    const hasLink = socialCopy.includes("http://") || socialCopy.includes("https://");
    const hasPromotional = socialCopy.includes("購買") || socialCopy.includes("預約") || socialCopy.includes("點擊") || socialCopy.includes("下單") || socialCopy.includes("限時");
